...
!function (t) {
  ...
  var i = {}, r = {}, o = [], a = window.Webflow || [], s = window.jQuery, u = s(window), c = s(document),
    l = s.isFunction, d = i._ = n(6), f = i.tram = n(1) && s.tram, h = !1, p = !1;
  ...
  window.tram = function (t) {
    ...
    var l = function (t, e, n) {
      ...
      }, h = document, p = window, v = "bkwld-tram", m = /[\-\.0-9]/g, w = /[A-Z]/, g = "number", b = /^(rgb|#)/,
      y = /(em|cm|mm|in|pt|pc|px)$/, x = /(em|cm|mm|in|pt|pc|px|%)$/, k = /(deg|rad|turn)$/, E = "unitless",
      _ = /(all|none) 0s ease 0s/, O = /^(width|height)$/, A = " ", T = h.createElement("a"),
      C = ["Webkit", "Moz", "O", "ms"], L = ["-webkit-", "-moz-", "-o-", "-ms-"], R = function (t) {
        if (t in T.style) return {dom: t, css: t};
        var e, n, i = "", r = t.split("-");
        for (e = 0; e < r.length; e++) i += r[e].charAt(0).toUpperCase() + r[e].slice(1);
        for (e = 0; e < C.length; e++) if ((n = C[e] + i) in T.style) return {dom: n, css: L[e] + t}
      }, S = e.support = {
    ...
    if (S.transition) {
      var I = S.timing.dom;
      if (T.style[I] = d["ease-in-back"][0], !T.style[I]) for (var D in f) d[D][0] = f[D]
    }
    var N = e.frame = function () {
      ...
      function n() {
        ...
        if (r) for (N(n), e = P(), t = r; t--;) (i = u[t]) && i.render(e)
      }
      ...
      e.init = function (t) {
        ...
        var t;
        this.active || (this.start || (this.start = P()), this.active = !0, t = this, 1 === u.push(t) && N(n))
      }, e.stop = function () {
        var e, n, i;
    ...
    var G = t.style, Z = t.css, X = {transform: S.transform && S.transform.css}, K = {
      color: [F, b],
    ...
    S.transform && (K.transform = [W], Y = {
      ...
      skewX: [k],
      skewY: [k]
    }), S.transform && S.backface && (Y.z = [x, "translateZ"], Y.rotateZ = [k], Y.scaleZ = [g], Y.perspective = [y]);
    var Q = /ms/, V = /s|\./;
    return t.tram = e
  }(window.jQuery)
}, function (t, e) {
  ...
  n(5), n(8), n(9), n(10), n(11), n(12), n(13), n(14), n(15), n(17), t.exports = n(22)
}, function (t, e, n) {
  "use strict";
  var i = n(0);
 ...
 */
  ...
  i.define("scroll", t.exports = function (t) {
    var e = {WF_CLICK_EMPTY: "click.wf-empty-link", WF_CLICK_SCROLL: "click.wf-scroll"}, n = window.location,
      ...
      l = "header, " + c + " > .header, " + c + " > .w-nav:not([data-no-scroll])", d = 'a[href="#"]',
      f = 'a[href*="#"]:not(.w-tab-link):not(' + d + ")", h = document.createElement("style");
          ...
          f.length && (e && (e.preventDefault(), e.stopPropagation()), function (t) {
            ...
            !function (e, n) {
              var i = o.scrollTop(), r = function (e) {
                var n = t(l), i = "fixed" === n.css("position") ? n.outerHeight() : 0, r = e.offset().top - i;
  ...
  i.define("dropdown", t.exports = function (t, e) {
    var n, u, c = e.debounce, l = {}, d = i.env(), f = !1, h = i.env.touch, p = ".w-dropdown", v = "w--open",
      m = r.triggers, w = 900, g = "focusout" + p, b = "keydown" + p, y = "mouseenter" + p, x = "mousemove" + p,
      k = "mouseleave" + p, E = (h ? "click" : "mouseup") + p, _ = "w-close" + p, O = "setting" + p, A = t(document);

    function T() {
      n = d && i.env("design"), (u = A.find(p)).each(C)
    }
    ...
    function C(e, r) {
      ...
      l || (l = t.data(r, p, {
        ...
        return function () {
          t.hovering = !1, t.links.is(":focus") || I(t)
        }
      ...
      var f = l.toggle.attr("id"), h = l.list.attr("id");
      f || (f = "w-dropdown-toggle-" + e), h || (h = "w-dropdown-list-" + e), l.toggle.attr("id", f), l.toggle.attr("aria-controls", h), l.toggle.attr("aria-haspopup", "menu"), l.toggle.attr("aria-expanded", "false"), l.toggle.find(".w-icon-dropdown-toggle").attr("aria-hidden", "true"), "BUTTON" !== l.toggle.prop("tagName") && (l.toggle.attr("role", "button"), l.toggle.attr("tabindex") || l.toggle.attr("tabindex", "0")), l.list.attr("id", h), l.list.attr("aria-labelledby", f), l.links.each(function (t, e) {
        e.hasAttribute("tabindex") || e.setAttribute("tabindex", "0"), s.test(e.hash) && e.addEventListener("click", I.bind(null, l))
      }), l.el.off(p), l.toggle.off(p), l.nav && l.nav.off(p);
      var m = R(l, a);
      n && l.el.on(O, function (t) {
        return function (e, n) {
          n = n || {}, L(t), !0 === n.open && S(t), !1 === n.open && I(t, {immediate: !0})
        }
      }(l)), n || (d && (l.hovering = !1, I(l)), l.config.hover && l.toggle.on(y, function (t) {
        return function () {
          t.hovering = !0, S(t)
        }
        ...
        return function (e) {
          if (!n && t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
            ...
            case o.ESCAPE:
              return I(t), t.toggle.focus(), e.stopPropagation();
            case o.ARROW_RIGHT:
            case o.ARROW_DOWN:
        ...
        return c(function (e) {
          ...
          return o || I(t), e.stopPropagation()
        })
    ...
    function R(t, e) {
      return c(function (n) {
        if (t.open || n && "w-close" === n.type) return I(t, {forceClose: e});
        S(t)
      })
    }
    ...
    function S(e) {
      if (!e.open) {
        ...
        var r = i.env("editor");
        n || A.on(E, e.mouseUpOutside), e.hovering && !r && e.el.on(k, e.mouseLeave), e.hovering && r && A.on(x, e.mouseMoveOutside), window.clearTimeout(e.delayId)
      }
    }
    ...
    function I(t) {
      ...
      if (t.open && (!t.config.hover || !t.hovering || i)) {
        ...
        var r = t.config;
        if (m.outro(0, t.el[0]), A.off(E, t.mouseUpOutside), A.off(x, t.mouseMoveOutside), t.el.off(k, t.mouseLeave), window.clearTimeout(t.delayId), !r.delay || n) return t.complete();
  ...
  "use strict";
  var i = n(2)(n(18)), r = n(0);
  r.define("forms", t.exports = function (t, e) {
    var n, o, a, s, u, c = {}, l = t(document), d = window.location, f = window.XDomainRequest && !window.atob,
      h = ".w-form", p = /e(-)?mail/i, v = /^\S+@\S+$/, m = window.alert, w = r.env(), g = /list-manage[1-9]?.com/i,
    ...
    function y(e, n) {
      ...
      r.done = a.find("> .w-form-done"), r.fail = a.find("> .w-form-fail"), r.fileUploads = a.find(".w-file-upload"), r.fileUploads.each(function (e) {
        !function (e, n) {
          ...
          var i, r = t(n.fileUploads[e]), o = r.find("> .w-file-upload-default"),
            a = r.find("> .w-file-upload-uploading"), s = r.find("> .w-file-upload-success"),
            c = r.find("> .w-file-upload-error"), l = o.find(".w-file-upload-input"),
            d = o.find(".w-file-upload-label"), f = d.children(), h = c.find(".w-file-upload-error-msg"),
            p = s.find(".w-file-upload-file"), v = s.find(".w-file-remove-link"),
            m = p.find(".w-file-upload-file-name"), g = h.attr("data-w-size-error"), b = h.attr("data-w-type-error"),
          ...
          if (d.on("click keydown", function (t) {
          ...
          }), d.find(".w-icon-file-upload-icon").attr("aria-hidden", "true"), v.find(".w-icon-file-upload-remove").attr("aria-hidden", "true"), w) l.on("click", function (t) {
            t.preventDefault()
            ...
            v.on("click keydown", function (t) {
              ...
              (i = r.target && r.target.files && r.target.files[0]) && (o.toggle(!1), c.toggle(!1), a.toggle(!0), a.focus(), m.text(i.name), T() || k(n), n.fileUploads[e].uploading = !0, function (e, n) {
                ...
                t.ajax({type: "POST", url: u, data: i, dataType: "json", crossDomain: !0}).done(function (t) {
                  n(null, t)
                }).fail(function (t) {
                  n(t)
                })
          ...
          function _(t) {
            ...
            "string" == typeof i && 0 === i.indexOf("InvalidFileTypeError") ? r = b : "string" == typeof i && 0 === i.indexOf("MaxFileSizeError") && (r = g), h.text(r), l.removeAttr("data-value"), l.val(""), a.toggle(!1), o.toggle(!0), c.toggle(!0), c.focus(), n.fileUploads[e].uploading = !1, T() || x(n)
          }
          ...
          function A(t) {
            if (t) return _(t);
            a.toggle(!1), s.css("display", "inline-block"), s.focus(), n.fileUploads[e].uploading = !1, T() || x(n)
          }
    ...
    function O(e) {
      ...
      i.fileUploads = function (e) {
        ...
        return e.find(':input[type="file"]').each(function (e, i) {
          var r = t(i), o = r.attr("data-name") || r.attr("name") || "File " + (e + 1), a = r.attr("data-value");
          "string" == typeof a && (a = t.trim(a)), n[o] = a
        }), n
      }(n), k(e), o ? t.ajax({url: s, type: "POST", data: i, dataType: "json", crossDomain: !0}).done(function (t) {
  ...
  i.define("navbar", t.exports = function (t, e) {
    var n, a, s, u, c = {}, l = t.tram, d = t(window), f = t(document), h = e.debounce, p = i.env(),
      v = '<div class="w-nav-overlay" data-wf-ignore />', m = ".w-nav", w = "w--open", g = "w--nav-dropdown-open",
    ...
    function A(n, i) {
      ...
      c && "/" === c.attr("href") && null == c.attr("aria-label") && c.attr("aria-label", "home"), a.button.attr("style", "-webkit-user-select: text;"), null == a.button.attr("aria-label") && a.button.attr("aria-label", "menu"), a.button.attr("role", "button"), a.button.attr("tabindex", "0"), a.button.attr("aria-controls", a.overlayContainerId), a.button.attr("aria-haspopup", "menu"), a.button.attr("aria-expanded", "false"), a.el.off(m), a.button.off(m), a.menu.off(m), L(a), s ? (C(a), a.el.on("setting" + m, function (t) {
        return function (n, i) {
          i = i || {};
          var r = d.width();
          L(t), !0 === i.open && F(t, !0), !1 === i.open && W(t, !0), t.open && e.defer(function () {
            r !== d.width() && S(t)
          })
        }
      }(a))) : (!function (e) {
        if (e.overlay) return;
        e.overlay = t(v).appendTo(e.el), e.overlay.attr("id", e.overlayContainerId), e.parent = e.menu.parent(), W(e, !0)
        ...
        return function (e) {
          switch (e.keyCode) {
            ...
            case o.ESCAPE:
              return W(t), e.preventDefault(), e.stopPropagation();
            case o.ARROW_RIGHT:
            case o.ARROW_DOWN:
            case o.HOME:
            case o.END:
        ...
        return function (e) {
          if (t.open) switch (t.selectedIdx = t.links.index(document.activeElement), e.keyCode) {
            ...
            case o.ESCAPE:
              return W(t), t.button.focus(), e.preventDefault(), e.stopPropagation();
            case o.ARROW_LEFT:
            case o.ARROW_UP:
    ...
    function F(t, e) {
      if (!t.open) {
        t.open = !0, t.menu.each(z), t.links.addClass(x), t.dropdowns.addClass(g), t.dropdownToggle.addClass(b), t.dropdownList.addClass(y), t.button.addClass(w);
        var n = t.config;
        ("none" === n.animation || !l.support.transform || n.duration <= 0) && (e = !0);
        var r = $(t), o = t.menu.outerHeight(!0), a = t.menu.outerWidth(!0), u = t.el.height(), c = t.el[0];
        if (P(0, c), k.intro(0, c), i.redraw.up(), s || f.on("click" + m, t.outside), e) p(); else {
    ...
    function W(t, e) {
      if (t.open) {
        ...
        var i = "transform " + n.duration + "ms " + n.easing2, r = t.menu.outerHeight(!0), o = t.menu.outerWidth(!0),
          a = t.el.height();
        if (n.animOver) l(t.menu).add(i).start({x: o * n.animDirect}).then(u); else {
          var s = a + r;
